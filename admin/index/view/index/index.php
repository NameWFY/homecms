            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> 房东管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{:url('index/Usermanage/indexadd')}">添加用户</a></li>
                      <li><a href="{:url('index/Usermanage/show')}">用户展示</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> 预约看房管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{:url('index/Usermanage/indexadd')}">添加用户</a></li>
                      <li><a href="{:url('index/Usermanage/show')}">用户展示</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> 租客资金管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{:url('index/Usermanage/indexadd')}">添加用户</a></li>
                      <li><a href="{:url('index/Usermanage/show')}">用户展示</a></li>
                    </ul>
