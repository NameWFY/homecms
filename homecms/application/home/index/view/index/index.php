	...
	<div class="container">
		...
		<div class="top-nav">
			<ul class="right-icons">
				...
				<?php if(empty($phone)) { ?>
				<li><a  href="{:url('login/login')}"><i class="glyphicon glyphicon-user"> </i>登录</a></li>
				<?php }else { ?>
				<li><a  href="{:url('login/out')}"><i class="glyphicon glyphicon-user"> </i>退出</a></li>
				<?php } ?>
		...
		<div class="container">
			<h3>Most Popular</h3>
				<div class="col-md-4 box_2">
			     	 <a href="{:url('single/single')}" class="mask">
