<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"D:\phpStudy\WWW\htdocs\month12\homecms\public/../application/home/index\view\index\index.php";i:1517291872;s:94:"D:\phpStudy\WWW\htdocs\month12\homecms\public/../application/home/index\view\common\footer.php";i:1517276095;}*/ ?>
<?php 
use think\Session;
$Session=Session::get('userinfo');

$aa=json_decode($Session,true);
	...
	<div class="container">
		...
		<div class="top-nav">
			<ul class="right-icons">
				<li><span ><i class="glyphicon glyphicon-phone"> </i><?php echo $phone; ?></span></li>
				<?php if(empty($phone)) { ?>
				<li><a  href="<?php echo url('login/login'); ?>"><i class="glyphicon glyphicon-user"> </i>登录</a></li>
				<?php }else { ?>
				<li><a  href="<?php echo url('login/out'); ?>"><i class="glyphicon glyphicon-user"> </i>退出</a></li>
				<?php } ?>
		...
		<div class="container">
			<h3>Most Popular</h3>
				<div class="col-md-4 box_2">
			     	 <a href="<?php echo url('single/single'); ?>" class="mask">
			  ...
			  <div class="<?php echo url('single/single'); ?>">
