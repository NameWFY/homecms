<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"D:\phpStudy\WWW\htdocs\month12\homecms\public/../application/home/index\view\login\login.php";i:1517291873;s:94:"D:\phpStudy\WWW\htdocs\month12\homecms\public/../application/home/index\view\common\header.php";i:1517276829;s:94:"D:\phpStudy\WWW\htdocs\month12\homecms\public/../application/home/index\view\common\footer.php";i:1517276095;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<title>Login</title>
	...
	<div class="container">
		...
		<div class="login-top">
			...
			<div class="create">
				...
				<a class="hvr-sweep-to-right" href="<?php echo url('register/register'); ?>">注册</a>
				<div class="clearfix"> </div>
			</div>
	</div>
</div>
  	...
  	$(document).on("click",'#sub',function(){
   		...
   		$.ajax({
   			...
   			success:function(res){
   				//alert($res);
   				if(res.msg=='0'){
		            alert('登录成功');location.href="<?php echo url('index/index'); ?>";
		        }else if(res.msg=='1'){
		            alert('登录失败');return;
		        }
   			}
