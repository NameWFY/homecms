<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:98:"D:\phpStudy\WWW\htdocs\month12\homecms\public/../application/admin/index\view\housing\indexadd.php";i:1516967538;}*/ ?>
<?php 
use think\Session;
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="<?php echo url('index/Housing/indexadddo'); ?>" method="post" novalidate>
