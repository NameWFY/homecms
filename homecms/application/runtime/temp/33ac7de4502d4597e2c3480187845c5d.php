<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\phpStudy\WWW\htdocs\month12\homecms\public/../application/admin/index\view\index\index.php";i:1517207149;}*/ ?>
<?php 
use think\Session;
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> 房源管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="<?php echo url('index/Housing/fenlei'); ?>">房源分类管理</a></li>
                    </ul>
                  </li>
